		...
		<Box bg={bgColor} p={4} borderRadius="md">
			<VStack spacing={4} align="stretch">
				...
				<Box>
					...
					<Select bg={selectBoxBgColor} placeholder="言語を選択" onChange={(e) => setLanguage(e.target.value)}>
						{/* 言語の選択肢 */}
					</Select>
				</Box>
				<Box>
					<Text color={textColor}>名前のテーマを選択してください</Text>
					<Select placeholder="名前のテーマを選択" onChange={(e) => setTheme(e.target.value)} bg={selectBoxBgColor}>
						{/* 名前のテーマの選択肢 */}
					</Select>
				</Box>
